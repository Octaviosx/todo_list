...
class TodoView:
    def __init__(self, window):
        ...
        self.window.title("To-do List Octavio")
        ...
        self.ctk_image = ctk.CTkImage(light_image=image, dark_image=image, size=(110, 135))
        self.label_img = ctk.CTkLabel(window, image=self.ctk_image, text="")
        self.label_img.pack(pady=40)
        
        self.entry = ctk.CTkEntry(window, width=200, fg_color="#5c5c5c", text_color='#f0f0f0')
        self.entry.pack(pady=10)
        
        self.buttonAdd = ctk.CTkButton(window, text='Agregar tarea', corner_radius=15, fg_color="DodgerBlue2", text_color="white")
        self.buttonAdd.pack()
        
        self.list = tk.Listbox(window, width=50, height=10, bg="#5c5c5c")
